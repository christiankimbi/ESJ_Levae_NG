...
export class LeaveService {
  ...
  getLeaveById(id: string): Observable<Result<LeaveRequestResult>> {
    return this.http.get<Result<LeaveRequestResult>>(`/api/leave/requests/${id}`);
  }

  getMyLeave(): Observable<Result<LeaveRequestResult[]>> {
    return this.http.get<Result<LeaveRequestResult[]>>(`/api/leave/requests/mine`);
  }
  ...
  getTeamLeave(): Observable<Result<LeaveRequestResult[]>> {
    return this.http.get<Result<LeaveRequestResult[]>>(`/api/leave/requests/team`);
  }
}
